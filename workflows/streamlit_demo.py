...
def main():
    ml_to_file = 'https://raw.githubusercontent.com/vburlay/anw_feld_ba/main/workflows/models/ml.csv'
    dl_to_file= 'https://raw.githubusercontent.com/vburlay/anw_feld_ba/main/workflows/models/dl.csv'
    lg_pred = pd.read_csv(ml_to_file)
